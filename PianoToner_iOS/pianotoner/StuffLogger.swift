...
//  MyTuna
//
//  Created by looka on 02/01/2018.
//  Copyright © 2018 themilletgrainfromouterspace.org. All rights reserved.
//
...
public class StuffLogger {
    ...
    public static func printeasy<T>(_ object: T, _ level: logLevel = .debug, filename: String = #file, line: Int = #line, funcname: String = #function) {
        #if DEBUG
